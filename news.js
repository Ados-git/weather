...
// apis 
const API_KEY = "72e0d43ce1254889a33f3820a1d6cbae";
...
const HEALTH_NEWS = "https://newsapi.org/v2/top-headlines?country=us&category=health&pageSize=8&apiKey=";
const SCIENCE_NEWS = "https://newsapi.org/v2/top-headlines?country=us&category=science&pageSize=8&apiKey=";
...
const fetchBreakingNews = async () => {
    ...
    if (response.ok) {
        ...
        let headlines = data.articles.map(news => news.title).join(" • ");
        document.getElementById("breakingNews").innerHTML = headlines;
    }

    displayNews();
};

// Add Fade-in Effect to News Articles
function displayNews() {
    newsdetails.innerHTML = "";
    newsDataArr.forEach(news => {
        let newsCard = document.createElement('div');
        newsCard.className = "col-lg-4 col-md-6 fade-in";
        newsCard.innerHTML = `
            <div class="card p-3">
                ...
                <div class="card-body">
                    ...
                    <a href="${news.url}" class="btn btn-dark" target="_blank">Read More</a>
                </div>
            </div>`;
